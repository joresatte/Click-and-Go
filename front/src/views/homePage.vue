<template>
    ...
    <div class="list" v-show="showList">
        <div class="col-12" v-for="(item, index) in customers" :key="index">
    ...
    <div class="grid" v-show="showGrid" >
        <div class="grid grid-nogutter" >
            <div class="col-12 sm:col-6 lg:col-12 xl:col-4 p-2" v-for="(item, index) in customers" :key="index">
                <div class="p-4 border-1 surface-border surface-card border-round">
                    <div class="flex flex-wrap align-items-center justify-content-between gap-2">
                    </div>
                    <div class="flex flex-column align-items-center gap-3 py-5">
                    <img class="w-4 sm:w-5rem xl:w-2rem shadow-2 block xl:block mx-auto border-round" src="@/assets/img/_copy.jpg" alt="image client" />
                    <div class="text-2xl font-bold">{{ item.cliente }}</div>
                    <span class="font-semibold">{{ item.address }}</span>
