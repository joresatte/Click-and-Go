      ...
      <Panel toggleable>
        ...
        <template #footer>
          <div class="flex flex-wrap align-items-center justify-content-between gap-3">
            ...
            <span class="p-text-secondary" v-if="showUpdated"
              >Last Updated: {{ lastUpdateDateTime }}</span
            >
          </div>
        </template>
        <template #icons>
        ...
        <p class="m-0"><i>total:</i> {{ pendingDataLength }}</p>
      </Panel>
    </div>
    <div class="card2">
      <Toast />
      <Panel toggleable>
        ...
        <p class="m-0"><i>total:</i> {{ deliveredDataLength }}</p>
      </Panel>
    </div>
  </div>
</template>
