...
def test_update_good_data():
    client= setup()
    request_data= client.put('/customer/1', json= good_request_data_1)
    if request_data==200:
...
def test_update_bad_request():
    client= setup()
    request_data= client.put('/customer/1', json= bad_request_data_1)
    if request_data==405:
        return True
    
def test_update_another_bad_request():
    client= setup()
    request_data= client.put('/customer/1', json= bad_request_data_2)
    if request_data==405:
        return True

def test_another_bad_request():
    client= setup()
    request_data= client.put('/customer/1', json= bad_request_data_3)
    if request_data==405:
        return True
...
def test_bad_request():
    client= setup()
    request_data= client.put('/customer/1', json= bad_request_data_4)
    if request_data==405:
        return True

def test_bad_request_data():
    client= setup()
    request_data= client.put('/customer/1', json= bad_request_data_5)
    if request_data==405:
        return True
